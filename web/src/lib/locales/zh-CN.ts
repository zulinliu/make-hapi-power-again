export default {
  ...
  'sessionLoom.status.synthesisReady': '本地提炼已生成。',
  ...
  'sessionLoom.synthesis.externalOff': '外部模型提炼默认关闭。本地提炼不会把会话内容发送给供应商。',
  'sessionLoom.synthesis.local': '创建本地提炼',
  ...
  'sessionLoom.error.synthesis': '创建本地提炼失败。',

export default {
  ...
  // Changes page
  'changes.tab.all': '全部',
  'changes.tab.pending': '待审查',
  'changes.tab.approved': '已批准',
  'changes.tab.rejected': '已拒绝',
  'changes.status.pending': '待审查',
  'changes.status.approved': '已批准',
  'changes.status.rejected': '已拒绝',
  'changes.type.created': '新建',
  'changes.type.modified': '修改',
  'changes.type.deleted': '删除',
  'changes.context': '上下文',
  'changes.approveAll': '全部批准',
  'changes.rejectAll': '全部拒绝',
  'changes.approve': '批准',
  'changes.reject': '拒绝',
  'changes.truncated': '消息较多，仅显示最近 200 条消息中的变更',
  'changes.loading': '加载中...',
  'changes.empty': '暂无变更记录',

  // Timeline page
  'timeline.tab.all': '全部',
  'timeline.tab.message': '消息',
  'timeline.tab.tool_use': '工具调用',
  'timeline.tab.file_change': '文件变更',
  'timeline.tab.summary': '摘要',
  'timeline.tab.checkpoint': '检查点',
  'timeline.tab.error': '错误',
  'timeline.createCheckpoint': '创建检查点',
  'timeline.truncated': '消息较多，仅显示最近 200 条消息',
  'timeline.loading': '加载中...',
  'timeline.empty': '暂无时间线记录',
  'timeline.role.assistant': '助手',
  'timeline.role.user': '用户',
  'timeline.summary.auto': '自动摘要',
  'timeline.summary.manual': '手动摘要',
  'timeline.checkpoint.tokens': '输入 {input}K / 输出 {output}K tokens',
  'timeline.error': '错误',

  // 撤销页面
  'undo.scopeLabel': '撤销范围',
  'undo.scope.session': '整个会话',
  'undo.scope.step': '到指定步骤',
  'undo.scope.file': '指定文件',
  'undo.stepSeqLabel': '回滚到步骤序号',
  'undo.filePathLabel': '文件路径',
  'undo.previewImpact': '预览影响',
  'undo.impactPreview': '影响预览',
  'undo.affectedFilesCount': '{n} 个文件受影响',
  'undo.type.created': '新建',
  'undo.type.modified': '修改',
  'undo.type.deleted': '删除',
  'undo.revertible': '可恢复',
  'undo.irreversible': '不可恢复',
  'undo.confirmUndo': '确认撤销',
  'undo.confirmMessage': '确定要撤销这些变更吗？此操作将标记文件为待恢复。',
  'undo.undoing': '撤销中…',
  'undo.confirmExecute': '确认执行',
  'undo.markedPending': '已标记为待恢复',
  'undo.snapshotNote': '文件已创建撤销快照记录。实际文件恢复需由代理执行。',
  'undo.skipped': '跳过',
  'undo.snapshotHistory': '快照历史',
  'undo.recordCount': '{n} 条记录',
  'undo.snapshotType.checkpoint': '检查点',
  'undo.snapshotType.undo': '撤销',
  'undo.snapshotType.auto': '自动',
  'undo.snapshotType.manual': '手动',
} as const

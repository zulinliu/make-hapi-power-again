export default {
  ...
  'sessionLoom.status.synthesisReady': 'Local synthesis is ready.',
  ...
  'sessionLoom.synthesis.externalOff': 'External model synthesis is off by default. Local synthesis does not send conversation content to a provider.',
  'sessionLoom.synthesis.local': 'Create local synthesis',
  ...
  'sessionLoom.error.synthesis': 'Failed to create local synthesis.',

...
// Git page
  ...
  'fm.dialog.move.title': 'Move items',
  'fm.dialog.move.submit': 'Move',
  'fm.dialog.copy.title': 'Copy items',
  'fm.dialog.copy.submit': 'Copy',
  'fm.dialog.transfer.source': 'Place "{name}" in the destination folder.',
  'fm.dialog.transfer.sourceMany': 'Place {count} selected items in the destination folder.',

...
// Git page
  ...
  'fm.dialog.create.title': 'New item',
  ...
  'fm.dialog.transfer.useThisFolder': 'Use this folder',
  ...
  'fm.dialog.transfer.hint': 'Type a path directly, or browse above to choose the destination folder. Items keep their current names.',

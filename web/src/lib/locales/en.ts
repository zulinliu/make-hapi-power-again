export default {
  ...
  'share.passwordHint': 'This share link is password protected',
  'share.enterPassword': 'Enter password',
  'share.confirm': 'Confirm',
  'share.wrongPassword': 'Incorrect password',
  'share.requestFailed': 'Request failed, please retry',
  'share.unavailable': 'Link unavailable',
  'share.notFound': 'Share link does not exist or has expired',
  'share.snapshot': 'Shared snapshot',
  'share.createdAt': 'Created',
  'share.validUntil': 'Valid until',
  'share.truncated': 'Large dataset — snapshot only includes changes from the last 200 messages',
  'share.truncatedSuffix': '... (truncated)',
  'share.noChanges': 'No file changes recorded',
  ...
  // Changes page
  'changes.tab.all': 'All',
  'changes.tab.pending': 'Pending',
  'changes.tab.approved': 'Approved',
  'changes.tab.rejected': 'Rejected',
  'changes.status.pending': 'Pending',
  'changes.status.approved': 'Approved',
  'changes.status.rejected': 'Rejected',
  'changes.type.created': 'Created',
  'changes.type.modified': 'Modified',
  'changes.type.deleted': 'Deleted',
  'changes.context': 'Context',
  'changes.approveAll': 'Approve All',
  'changes.rejectAll': 'Reject All',
  'changes.approve': 'Approve',
  'changes.reject': 'Reject',
  'changes.truncated': 'Too many messages, showing changes from the latest 200 messages only',
  'changes.loading': 'Loading...',
  'changes.empty': 'No changes yet',

  // Timeline page
  'timeline.tab.all': 'All',
  'timeline.tab.message': 'Messages',
  'timeline.tab.tool_use': 'Tool Calls',
  'timeline.tab.file_change': 'File Changes',
  'timeline.tab.summary': 'Summaries',
  'timeline.tab.checkpoint': 'Checkpoints',
  'timeline.tab.error': 'Errors',
  'timeline.createCheckpoint': 'Create Checkpoint',
  'timeline.truncated': 'Too many messages, showing the latest 200 only',
  'timeline.loading': 'Loading...',
  'timeline.empty': 'No timeline records yet',
  'timeline.role.assistant': 'Assistant',
  'timeline.role.user': 'User',
  'timeline.summary.auto': 'Auto summary',
  'timeline.summary.manual': 'Manual summary',
  'timeline.checkpoint.tokens': 'Input {input}K / Output {output}K tokens',
  'timeline.error': 'Error',

  // Undo page
  'undo.scopeLabel': 'Undo scope',
  'undo.scope.session': 'Entire session',
  'undo.scope.step': 'To a specific step',
  'undo.scope.file': 'Specific file',
  'undo.stepSeqLabel': 'Roll back to step number',
  'undo.filePathLabel': 'File path',
  'undo.previewImpact': 'Preview impact',
  'undo.impactPreview': 'Impact preview',
  'undo.affectedFilesCount': '{n} files affected',
  'undo.type.created': 'Created',
  'undo.type.modified': 'Modified',
  'undo.type.deleted': 'Deleted',
  'undo.revertible': 'Revertible',
  'undo.irreversible': 'Irreversible',
  'undo.confirmUndo': 'Confirm undo',
  'undo.confirmMessage': 'Are you sure you want to undo these changes? Files will be marked for restoration.',
  'undo.undoing': 'Undoing…',
  'undo.confirmExecute': 'Confirm',
  'undo.markedPending': 'Marked for restoration',
  'undo.snapshotNote': 'Undo snapshot records created. Actual file restoration will be performed by the agent.',
  'undo.skipped': 'Skipped',
  'undo.snapshotHistory': 'Snapshot history',
  'undo.recordCount': '{n} records',
  'undo.snapshotType.checkpoint': 'Checkpoint',
  'undo.snapshotType.undo': 'Undo',
  'undo.snapshotType.auto': 'Auto',
  'undo.snapshotType.manual': 'Manual',
} as const

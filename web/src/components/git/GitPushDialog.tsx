                    ...
                    <div className="flex items-center gap-4">
                        <label className="flex items-center gap-2 text-sm">
                            <input
                                ...
                                className="rounded"
                            />
                            <span className="text-[var(--hp-text-secondary)]">{t('git.push.setUpstream')}</span>
                        </label>
                        <label className="flex items-center gap-2 text-sm">
                            <input
                                type="checkbox"
                                ...
                                className="rounded"
                            />
                            <span className="text-[var(--hp-danger)]">{t('git.push.force')}</span>
                        </label>
                    </div>

                    {forcePush && (
                        <div className="rounded-[var(--hp-radius-sm)] bg-[var(--hp-danger-subtle)] p-3 text-sm">

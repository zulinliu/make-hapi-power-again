        ...
        return (
            <div className="flex flex-col h-full bg-[--hp-surface-0]">
                ...
                <div className="flex-1 flex flex-col items-center justify-center gap-3 px-6 text-center">
                    ...
                    <code className="px-3 py-1.5 text-xs rounded-[--hp-radius-sm,6px] bg-[--hp-surface-1] text-[--hp-text-primary]">
                ...
                {currentPath && (
                    <div className="mt-2 flex items-center gap-1 text-xs overflow-x-auto">
                        <button
                            ...
                            onClick={handleGoUp}
                            disabled={atRoot}
                            className="shrink-0 p-0.5 rounded-[--hp-radius-xs,4px] hover:bg-[--hp-surface-1] text-[--hp-text-tertiary] hover:text-[--hp-text-primary] transition-colors disabled:opacity-30"
                            title={t('browse.goUp')}
                        ...
                        <button
                            ...
                            disabled={isLoading}
                            className="ml-auto shrink-0 p-0.5 rounded-[--hp-radius-xs,4px] hover:bg-[--hp-surface-1] text-[--hp-text-tertiary] hover:text-[--hp-text-primary] transition-colors"
                    ...
                    <div className="flex flex-col px-2 py-1">
                        {directories.map(entry => (
                            <button
                                ...
                                className="flex items-center gap-2 px-2 py-2 rounded-[--hp-radius-md,8px] text-left hover:bg-[--hp-surface-1] transition-colors w-full"
                            >
                                {entry.isGitRepo ? (
                                ...
                                {entry.isGitRepo && (
                                    <span className="text-[10px] px-1.5 py-0.5 rounded-[--hp-radius-xs,4px] bg-[--hp-warning-subtle] text-[--hp-warning] font-medium shrink-0">git</span>
                                )}
                            </button>
                        ))}
                    </div>
                ...
                <div className="px-3 py-2 border-t border-[--hp-divider]">
                    <div className="flex items-center gap-2">
                        ...
                        <button
                            ...
                            className="px-4 py-1.5 text-sm rounded-[--hp-radius-sm,6px] bg-[--hp-primary] text-[--hp-primary-text] font-medium disabled:opacity-50 transition-colors hover:opacity-90"
                        >

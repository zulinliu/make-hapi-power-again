            ...
            <div className="px-3 pb-3">
                {tab === 'relative' ? (
                            ...
                            return (
                                <button
                                    ...
                                    className={`rounded-lg border px-3 py-2 text-sm font-medium transition-colors ${
                                        isSelected
                                            ? 'border-[var(--hp-primary)] bg-[var(--hp-primary)] text-[var(--hp-primary-text)]'
                    ...
                    <div className="flex flex-col gap-2">
                        ...
                        />
                        {specificError ? (
                            <p className="text-xs text-[var(--hp-danger)]">{specificError}</p>
                        ) : (
                        ...
                        <button
                            ...
                            className="w-full rounded-lg bg-[var(--hp-primary)] px-3 py-2 text-sm font-medium text-[var(--hp-primary-text)] transition-colors hover:bg-[var(--hp-primary-hover)] disabled:cursor-not-allowed disabled:opacity-40"
                        >
                            {t('composer.scheduleSend')}
                        </button>
                    </div>

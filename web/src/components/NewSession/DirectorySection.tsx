...
export function DirectorySection(props: {
    ...
    return (
        <div className="flex flex-col gap-1.5 px-3 py-3">
            ...
            <div className="flex items-start gap-2">
                <div className="relative flex-1 min-w-0">
                    <div className="relative">
                        ...
                        <input
                            ...
                            className="w-full rounded-[--hp-radius-sm,6px] border border-[--hp-border] bg-[--hp-surface-0] p-2 pl-8 text-sm text-[--hp-text-primary] placeholder:text-[--hp-text-tertiary] focus:outline-none focus:ring-2 focus:ring-[--hp-primary] focus:border-transparent disabled:opacity-50 transition-colors"
                        />
                    </div>
                ...
                {props.onChooseFolder && (
                    <button
                        ...
                        disabled={props.isDisabled}
                        className="shrink-0 flex items-center gap-1 rounded-[--hp-radius-sm,6px] border border-[--hp-border] bg-[--hp-surface-1] px-2 py-2 text-xs text-[--hp-text-secondary] hover:bg-[--hp-surface-2] hover:text-[--hp-text-primary] transition-colors disabled:opacity-50"
                    ...
                    <div className="flex flex-wrap gap-1">
                        {props.recentPaths.map((path) => (
                            <button
                                ...
                                disabled={props.isDisabled}
                                className="rounded-[--hp-radius-sm,6px] bg-[--hp-surface-1] px-2 py-1 text-xs text-[--hp-text-secondary] hover:bg-[--hp-surface-2] hover:text-[--hp-text-primary] transition-colors truncate max-w-[200px] disabled:opacity-50"
                                title={path}
                            >
                                {path}
                            </button>
            ...
            {props.statusMessage ? (
                <div
                    className={`mt-1 rounded-[--hp-radius-sm,6px] px-2 py-1 text-xs ${

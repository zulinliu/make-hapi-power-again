...
- 已完成 v0.17 文件管理器专项质量门禁：typecheck、shared/hub/web/cli 测试、全量测试、build、品牌残留扫描、diff 检查。
- 已补充 `.planning/phases/35-v0.17-file-manager-production/35-RELEASE-CHECKLIST.md`，记录发布前检查项和剩余非阻断风险。
- 全局 `/browse` 当前已具备无会话浏览、上一级、隐藏文件、新建、删除、重命名、移动、复制、预览编辑、上传、下载、搜索和从目录启动会话。

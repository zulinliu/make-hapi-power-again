...
- [ ] **Phase 0.5: 技术验证** — PoC 验证关键技术风险
- [ ] **Phase 1: 架构基础** — EventBus、设计系统、安全中间件、代码分割、统一导航
- [ ] **Phase 2: Git 管理** — Git 可视化管理 + GitInternalAPI
...
|-------|----------------|--------|-----------|
| 0.5. 技术验证 | 0/1 | Not started | - |
| 1. 架构基础 | 0/4 | Not started | - |
| 2. Git 管理 | 0/3 | Not started | - |

...
*Last updated: 2026-05-31 — Phase 23~24 全部完成, Phase 25 环境变量改名待规划*
...
### Phase 25: 环境变量全量改名（可选）
**Goal**: 将 CLI 代码中残留的 ~50 处 HAPI_* 环境变量统一为 HAPI_POWER_*
**风险**: 需要兼容已有用户配置，需运行时回退逻辑（先读 HAPI_POWER_*，不存在则读 HAPI_*）
**状态**: 待规划

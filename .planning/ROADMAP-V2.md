...
**Success Criteria**:
  ...
  5. ~~AI 工作流：变更审查/时间线/撤销/上下文正常~~ → v0.12.0 已删除变更审查/时间线/撤销
  6. ~~代理体验：语音/白板/Skill 编排正常~~ → v0.12.0 已删除语音/白板/编排
...
**Success Criteria**:
  ...
  4. ~~移动端 AI 聊天布局优化（语音按钮 + 气泡适配 + 快速操作）~~ → v0.12.0 已删除语音
  5. ~~移动端变更审查支持 swipe approve/reject 手势~~ → v0.12.0 已删除变更审查

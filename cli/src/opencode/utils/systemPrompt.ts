...
/**
 * Title instruction for OpenCode to call the hapi-power MCP tool.
 */
export const TITLE_INSTRUCTION = trimIdent(`
    ...
    When you create or find a local image file that the user should see, call the tool "hapi_display_image" with the image path so Hapi Power can show it inline.
`);
...
/**
 * Instruction prepended to OpenCode prompts while Hapi Power plan mode is active.
 */
